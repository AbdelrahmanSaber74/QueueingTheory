...
public class M_M_1OutputScreen extends javax.swing.JFrame {
    private static M_M_1 obj;
    public M_M_1OutputScreen(M_M_1 var) {
        initComponents();
        obj = var;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(M_M_1OutputScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new M_M_1OutputScreen(obj).setVisible(true);
            }
        });
    }
