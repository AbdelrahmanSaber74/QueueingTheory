 ...
 */
public class M_M_c_KInputScreen extends javax.swing.JFrame {

    /**
     * Creates new form M_M_1InputScreen
     */
    public M_M_c_KInputScreen() {
        initComponents();
    }
    ...
    private void enterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enterActionPerformed
        ...
        {
            M_M_c_KOutputScreen screen = new M_M_c_KOutputScreen(new M_M_c_K(arrivalRate, serviceRate, c, K));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(M_M_c_KInputScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new M_M_c_KInputScreen().setVisible(true);
            }
        });
    }
