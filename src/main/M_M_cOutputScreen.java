...
public class M_M_cOutputScreen extends javax.swing.JFrame {
    private static M_M_c obj;
    public M_M_cOutputScreen(M_M_c var) {
        initComponents();
        obj = var;
        ...
        ciOutput.setText(format.format(obj.getCi()));
    }
    ...
    private void initComponents() {
        ...
        ciOutput = new javax.swing.JTextField();
        ...
        ciLabel.setFont(new java.awt.Font("Gabriola", 1, 26)); // NOI18N
        ciLabel.setForeground(new java.awt.Color(130, 0, 0));
        ciLabel.setText("Ci = ");

        ciOutput.setEditable(false);
        ciOutput.setBackground(new java.awt.Color(230, 230, 230));
        ciOutput.setFont(new java.awt.Font("Courier New", 1, 18)); // NOI18N
        ciOutput.setForeground(new java.awt.Color(0, 130, 0));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(68, 68, 68)
                        .addComponent(cLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(5, 5, 5)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(ciLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 57, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(7, 7, 7)
                                .addComponent(ciOutput)))))
                .addGap(5, 5, 5))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(5, 5, 5)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(ciLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(ciOutput, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(5, 5, 5)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(M_M_cOutputScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new M_M_cOutputScreen(obj).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField ciOutput;
